...
<tmp:adminTemplate title="Admin - Linh Farm">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-data__tool">
                                <div class="table-data__tool-left">
                                    <h3 class="title-5 m-t-10">QUẢN LÝ NHÂN VIÊN</h3>
                                </div>
...
<%--                                        </td>--%>
        ...
        <script type="text/javascript">
            ...
            $("#submitSearch").on('click',()=>{
                ...
                $(location).attr('href','searchEmployee?searchBy='+searchBy+'&keyword='+keyword);
